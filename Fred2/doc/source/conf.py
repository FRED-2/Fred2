# -*- coding: utf-8 -*-
#
# FRED2 documentation build configuration file, created by
...
project = u'FRED'
copyright = u'2014, Schbert Walzer Brachvogel'
...
latex_documents = [
  ('index', 'FRED2.tex', u'FRED2 Documentation',
   u'Schbert Walzer Brachvogel', 'manual'),
]
...
man_pages = [
    ('index', 'fred2', u'FRED2 Documentation',
     [u'Schbert Walzer Brachvogel'], 1)
]
...
texinfo_documents = [
  ('index', 'FRED2', u'FRED2 Documentation',
   u'Schbert Walzer Brachvogel', 'FRED2', 'One line description of project.',
   'Miscellaneous'),
]
