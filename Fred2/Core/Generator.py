...
def generate_peptides_from_variants2(vars, length, dbadapter, peptides=None):
    ...
    for tId, vs in transToVar.iteritems():
        ...
        for start in xrange(0, len(tSeq) + 1 - 3 * length, 3):
            ...
            if vars_in_window:
                ...
                for tId, varSeq, varComb in _generate_combinations(tId, vars, list(tSeq), {}, 0, strand == REVERS):
...
#
#     :param list(Variant) vars: Lst of Variants
