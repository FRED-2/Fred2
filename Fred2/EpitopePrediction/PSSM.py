    ...
    def predict(self, peptides, alleles=None, **kwargs):
        ...
        for length, peps in itertools.groupby(pep_seqs.iterkeys(), key= lambda x: len(x)):
            ...
            for a in allales_string.keys():
                ...
                for p in peps:
		    print [(self.name, type(pssm[i][p[i]]),a,i,p[i]) for i in xrange(length)]
...
class Syfpeithi(APSSMEpitopePredictor):
    ...
    """
    __alleles = frozenset(['B*15:10', 'B*41:01', 'B*37:01', 'B*27:05', 'B*38:01', 'A*02:01', 'B*47:01', 'A*26:01', 'B*3701',
...
class BIMAS(APSSMEpitopePredictor):
    ...
    __alleles = frozenset(['B*04:01', 'A*31:01', 'B*58:01', 'Cw*06:02', 'A*03:01', 'B*35:01',
